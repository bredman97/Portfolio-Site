...
export default function ContactPage() {
    ...
    return (
        ...
        <div className="min-h-screen">
            ...
            <form onSubmit={handleSubmit} class="max-w-sm md:max-w-md mx-auto mt-10 p-4 pt-16 rounded-3xl shadow-inner shadow-black">
                <div className="relative z-0 mb-12 w-full group">
                    <input type="text" value={name} onChange={(e) => setName(e.target.value)} className="block w-full text-sm text-black bg-transparent border-0 border-b-2 border-black appearance-none focus:outline-none peer" placeholder=" " required/>
                ...
                <div className="relative z-0 mb-12 w-full group">
                    <input type="email" value={email} onChange={(e) => setEmail(e.target.value)} className="block w-full text-sm text-black bg-transparent border-0 border-b-2 border-black appearance-none focus:outline-none peer" placeholder=" " required/>
                ...
                <div className="relative z-0 mb-12 w-full group">
                    <input type="text" value={message} onChange={(e) => setMessage(e.target.value)} className="overflow-x-scroll block w-full text-sm text-black bg-transparent border-0 border-b-2 border-black appearance-none focus:outline-none peer" placeholder=" " required/>
