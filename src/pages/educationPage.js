    ...
    return (
        ...
        <div className='flex flex-col p-5 gap-3'>
          ...
          <p className='ps-2 rounded-md shadow-md shadow-blue-600'>
            ...
            <p className="italic font-light">Jan 2022 – June 2026</p>

            <p className="font-medium text-lg">Associate of Science – Computer Information Systems</p>
            <p className="italic font-light">The Bermuda College, Paget, Bermuda	</p>
            <p className="italic font-light">Aug 2018 – May 2021</p>
          ...
          <p className='ps-2 rounded-md shadow-md shadow-blue-600'>
            ...
            <p className="font-medium text-lg">LAN Switching</p>
            ...
            <p className="font-medium text-lg">Wireshark</p>
