        ...
        <header className='flex text-white bg-blue-600 overflow-x-scroll scroll-smooth md:overflow-hidden md:p-6 justify-between shadow-sm shadow-black'>
            <Menu>
                ...
                <MenuItems anchor='bottom' className='text-white w-32 ml-1 md:ml-6 mt-4 rounded-lg border-white text-lg bg-blue-600 focus:border-transparent focus:outline-none focus:ring-0'>
                    ...
                    <MenuItem>
                        <Link to='/about' className="inline-flex gap-1 items-center data-[focus]:bg-amber-500">
                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="size-4">
                    ...
                    <MenuItem>
                        <Link to='/qualifications' className="inline-flex gap-1 items-center data-[focus]:bg-amber-500">
                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="size-4">
                    ...
                    <MenuItem>
                        <Link to='/experience' className="inline-flex gap-1 items-center data-[focus]:bg-amber-500">
                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="size-4">
                    ...
                    <MenuItem>
                        <Link to='/contact' className="inline-flex gap-1 items-center data-[focus]:bg-amber-500">
                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="size-4">
                ...
                <NavLink to='/' active='' className='inline-flex gap-1 hover:bg-amber-500 hover:animate-pulse rounded-full shadow-lg shadow-white md:aria-[current=page]:animate-bounce'>Home
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="size-6">
                <path stroke-linecap="round" stroke-linejoin="round" d="m2.25 12 8.954-8.955c.44-.439 1.152-.439 1.591 0L21.75 12M4.5 9.75v10.125c0 .621.504 1.125 1.125 1.125H9.75v-4.875c0-.621.504-1.125 1.125-1.125h2.25c.621 0 1.125.504 1.125 1.125V21h4.125c.621 0 1.125-.504 1.125-1.125V9.75M8.25 21h8.25" />
                </svg>
                </NavLink>
